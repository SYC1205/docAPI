package com.e104.DocumentManagement;
...
@Path("/example")
@Api(value = "/example", description = "User REST for Integration Testing")
...
public interface FileManageService {
  ...
  // @GET
  // @Path("/{id}")
  // public String putFile(@PathParam("id") String id);
   ...
   @Consumes("application/json")
   @ApiOperation(value = "Get user details")
   public String getFileurl(String jsonObj) throws DocApplicationException;
   ...
   @ApiResponses(value = { @ApiResponse(code = 200, message = "http/1.1 200 OK{\"error\":\"\",\"data\":\"\",\"success\":\"true\"}")})
   public String encryptParam(@ApiParam(value = "encrypt data", required = true) @PathParam("Param") String Param);
